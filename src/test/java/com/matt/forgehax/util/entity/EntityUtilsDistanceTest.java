...
public class EntityUtilsDistanceTest {
  ...
  private static final AABB TALL = new AABB(0.D, 0.D, 0.D, 1.D, 8.D, 1.D);

  @Test
  public void insideTheBoxIsZero() {
    assertEquals(0.D, EntityUtils.getDistanceSq(new Vec3(0.5D, 4.D, 0.5D), TALL), 1E-9);
  }
  ...
  public void measuresToTheNearestFaceNotTheCenter() {
    ...
    Vec3 eyes = new Vec3(3.D, 0.5D, 0.5D);
  ...
  public void combinesAxesOnDiagonals() {
    ...
    Vec3 eyes = new Vec3(4.D, 4.D, 5.D);
