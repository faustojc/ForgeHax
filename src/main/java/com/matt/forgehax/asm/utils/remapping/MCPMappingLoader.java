...
public class MCPMappingLoader {
  ...
  private final SrgFile srgFileData;
  private final ExcFile excFileData;
  private final StaticMethodsFile staticMethods;
  private final CsvFile csvFieldData;
  private final CsvFile csvMethodData;
  private final ParamCsvFile csvParamData;
