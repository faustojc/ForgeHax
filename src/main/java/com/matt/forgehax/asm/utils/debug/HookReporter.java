...
public class HookReporter {
  ...
  private final MultiBoolean activator = new MultiBoolean();
  ...
  public static class Builder {
    ...
    private final List<ASMMethod> hookedMethods = Lists.newArrayList();
    private final List<Class<?>> eventClasses = Lists.newArrayList();
     ...
     *
     * @param parentClass
     *     parent class containing the method
     * @return this
     */
